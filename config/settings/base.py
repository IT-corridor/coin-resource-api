"""
Base settings for mutualcoin project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (mutualcoin/config/settings/base.py - 3 = mutualcoin/)
APPS_DIR = ROOT_DIR.path('mutualcoin')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'mutualcoin.contrib.sites.migrations'
}
...
# ADMINS = [
#     ("""MutualCoin""", 'admin@mutualcoin.fund'),
# ]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///mutualcoin'),
}
...
SOCIALACCOUNT_ADAPTER = 'mutualcoin.users.adapters.SocialAccountAdapter'
...
ALLOWED_HOSTS = ['mutualcoin.fund','api.mutualcoin.fund', '137.135.96.39', '*']
APPEND_SLASH = True
