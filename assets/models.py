...
class Asset(models.Model):
    ...
    amount = models.DecimalField(max_digits=32, decimal_places=16, default=0.00)
    ...
    purchase_price = models.DecimalField(max_digits=20, decimal_places=12, default=0.00)
...
class SoldAssets(models.Model):
    ...
    purchase_price = models.DecimalField(max_digits=20, default=0.00, decimal_places=12)
    amount = models.DecimalField(max_digits=32, decimal_places=16, default=0.00)
