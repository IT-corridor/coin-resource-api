...
class Asset(models.Model):
    ...
    purchase_price = models.DecimalField(max_digits=32, decimal_places=16, default=0.00)
...
class SoldAssets(models.Model):
    ...
    purchase_price = models.DecimalField(max_digits=32, default=0.00, decimal_places=16)
    amount = models.DecimalField(max_digits=32, decimal_places=8, default=0.00)
